    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
      <header className="container mx-auto px-4 py-6 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          <Image src="/Icon.svg" alt="Positivus" width={42} height={42} />
      ...
      <main className="container mx-auto px-4 py-12 md:py-20 flex flex-col md:flex-row items-start gap-12">
        <div className="md:w-1/2 relative">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
            It’s <span className="text-blue-500">Time </span>
            to <span className="text-blue-500">Grow</span>
            <br />
